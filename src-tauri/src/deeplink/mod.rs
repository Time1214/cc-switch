//! Deep link import functionality for CC Switch-S
//!
//! This module implements the ccswitchs:// protocol for importing configurations
...
///
/// Represents a parsed ccswitchs:// URL ready for processing.

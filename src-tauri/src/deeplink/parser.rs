...
//!
//! Parses ccswitchs:// URLs into DeepLinkImportRequest structures.
...
/// Parse a ccswitchs:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// ccswitchs://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "ccswitchs" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'ccswitchs', got '{scheme}'"
        )));
    }
